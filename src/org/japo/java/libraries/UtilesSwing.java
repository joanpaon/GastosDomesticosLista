...
public final class UtilesSwing {
    ...
    public static final boolean validarCampoDNI(JTextField txfActual) {
        return UtilesDNI.validar(txfActual.getText().trim());
    }

    // Campo de texto con FECHA + Texto campo vacío
    public static final boolean validarCampoFecha(JTextField txfActual) {
        return UtilesTemporales.validarFecha(txfActual.getText().trim());
    }
